...
def load_file(filename):
    """Load a TESS FITS file and return TIME, PDCSAP_FLUX"""
    hdu = fits.open(filename)
    time = hdu[1].data['TIME']
    flux = hdu[1].data['PDCSAP_FLUX']
    flux[flux == 0] = np.nan  # faulty and missing data
    return time, flux
...
filename = 'https://archive.stsci.edu/hlsps/tess-data-alerts/hlsp_tess-data-alerts_tess_phot_00062483237-s01_tess_v1_lc.fits'
